...
/**
 * Created by spiros on 11/4/13.
 */
public class UploadOpenThread extends AsyncTask<Void, Void, Integer> {
	...
	public UploadOpenThread(Context context, SocialWifi socialWifi, String ssid, String bssid, String password, String extraInfo) {
	...
	protected Integer doInBackground(Void... params) {
		...
		if (!WifiUtils.connect(WifiUtils.createConfigFile(ssid, password, extraInfo), socialWifi.getWifiManager(), socialWifi.getConnectivityManager()))
